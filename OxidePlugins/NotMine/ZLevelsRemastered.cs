...
namespace Oxide.Plugins
{
    ...
    class ZLevelsRemastered : RustPlugin
    {
        ...
        void GUIUpdateSkill(BasePlayer player, string skill)
        {
            ...
            var lvText1 = new CuiElement
            {
                ...
                Components = {
                    ...
                    new CuiRawImageComponent { Url = "https://cdn.discordapp.com/avatars/137672086536585217/9be3ae71993be3181f6ef0ed3d6e7f8c.png" },   
        ...
        void CreateGUI(BasePlayer player)
        {
            ...
            var miningIcon = new CuiElement {
                Name = CuiHelper.GetGuid(),
                Parent = panelName,
                Components = {
                    new CuiRawImageComponent { Url = "https://static.wikia.nocookie.net/play-rust/images/8/86/Pick_Axe_icon.png/revision/latest/scale-to-width-down/256?cb=20151106061323" },
                    new CuiRectTransformComponent{ AnchorMin = "0.035 0.0", AnchorMax = $"0.15 0.1" }
                }
            };
            mainContainer.Add(miningIcon);

            var woodcuttingIcon = new CuiElement {
                Name = CuiHelper.GetGuid(),
                Parent = panelName,
                Components = {
                    new CuiRawImageComponent { Url = "https://static.wikia.nocookie.net/play-rust/images/0/06/Hatchet_icon.png/revision/latest/scale-to-width-down/256?cb=20151106061743" },
                    new CuiRectTransformComponent{ AnchorMin = "0.035 -0.5", AnchorMax = $"0.15 0.1" }
                }
            };
            mainContainer.Add(woodcuttingIcon);

            var craftingIcon = new CuiElement {
                Name = CuiHelper.GetGuid(),
                Parent = panelName,
                Components = {
                    new CuiRawImageComponent { Url = "https://static.wikia.nocookie.net/play-rust/images/5/57/Hammer_icon.png/revision/latest/scale-to-width-down/256?cb=20151106061319" },
                    new CuiRectTransformComponent{ AnchorMin = "0.035 -1.0", AnchorMax = $"0.15 0.15" }
                }
            };
            mainContainer.Add(craftingIcon);
